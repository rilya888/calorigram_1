...
def add_meal(telegram_id: int, meal_type: str, meal_name: str, dish_name: str, 
    ...
    try:
        logger.info(f"Adding meal to database: telegram_id={telegram_id}, meal_type={meal_type}, meal_name={meal_name}, dish_name={dish_name}, calories={calories}, analysis_type={analysis_type}")
